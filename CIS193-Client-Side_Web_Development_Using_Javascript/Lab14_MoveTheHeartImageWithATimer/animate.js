...
function startAnimation(e) {
   ...
   // Stop the timer if it is already running from a previous click 
   if(timerId != null)
   {
   ...
   // Start a new timer that runs the moveImage function every 10 milliseconds
...
function moveImage(x, y) {
   ...
   // If the image has reached the final destination, stop the timer
