...
function showCircleClick() {
   ...
   circlePromise.then(promiseFulfilled, promiseRejected);
}

function promiseFulfilled(divElement)
{
   divElement.innerText = "Ta da!";
}

function promiseRejected(errorMessage)
{
   alert(errorMessage);
}
